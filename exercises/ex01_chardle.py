...
if (number_of_count == 2):
    print("2 instances of " + single_character + " found in " + chosen_word)
if (number_of_count == 3):
    print("3 instances of " + single_character + " found in " + chosen_word)
if (number_of_count == 4): 
    print("4 instances of " + single_character + " found in " + chosen_word)
if (number_of_count == 5): 
    print("5 instances of " + single_character + " found in " + chosen_word)